...
func TestNewDoTClient_BareIPv4DefaultPort(t *testing.T) {
	c, err := NewDoTClient("1.1.1.1", false, "auto", resolveDisabled)
	if err != nil {
...
func TestNewDoTClient_HostnameWithPort(t *testing.T) {
	c, err := NewDoTClient("dns.example.com:853", false, "auto", resolveDisabled)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestNewDoTClient_VerifyCertTrue(t *testing.T) {
	c, err := NewDoTClient("1.1.1.1:853", true, "auto", resolveDisabled)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
...
func TestNewDoTClient_VerifyCertFalse(t *testing.T) {
	c, err := NewDoTClient("1.1.1.1:853", false, "auto", resolveDisabled)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	if !c.tlsConfig.InsecureSkipVerify {
...
func TestDoTClient_SuccessfulQuery(t *testing.T) {
	...
	client, err := NewDoTClient(addr, false, "auto", resolveDisabled)
	if err != nil {
...
func TestDoTClient_UnreachableServer(t *testing.T) {
	...
	client, err := NewDoTClient("127.0.0.1:1", false, "auto", resolveDisabled)
	if err != nil {
		t.Fatalf("NewDoTClient: %v", err)
	}
...
func TestDoTClient_WithBootstrap(t *testing.T) {
	...
	c, err := NewDoTClient("dns.example.test:853", false, "auto", resolveDisabled, bootstrapAddr)
	if err != nil {
...
func TestDoTClient_BootstrapFailureFallback(t *testing.T) {
	...
	c, err := NewDoTClient("dns.example.test:853", false, "auto", resolveDisabled, "127.0.0.1:1")
	if err != nil {
