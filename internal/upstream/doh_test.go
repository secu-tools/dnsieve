...
func TestDoHClient_SuccessfulQuery(t *testing.T) {
	...
	client, err := NewDoHClient(srv.URL+"/dns-query", false)
	if err != nil {
...
func TestNewDoHClient_VerifyCertTrue(t *testing.T) {
	c, err := NewDoHClient("https://dns.example.com/dns-query", true)
	if err != nil {
...
func TestNewDoHClient_VerifyCertFalse(t *testing.T) {
	c, err := NewDoHClient("https://dns.example.com/dns-query", false)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	transport := c.httpClient.Transport.(*http.Transport)
...
func TestDoHClient_String(t *testing.T) {
	c, err := NewDoHClient("https://dns.quad9.net/dns-query", false)
	if err != nil {
		t.Fatalf("unexpected error: %v", err)
	}
	s := c.String()
...
func TestDoHClient_UnreachableServer(t *testing.T) {
	client, err := NewDoHClient("https://127.0.0.1:1/dns-query", false)
	if err != nil {
		t.Fatalf("NewDoHClient: %v", err)
	}
